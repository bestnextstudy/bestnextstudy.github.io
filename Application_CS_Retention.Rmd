...
In this page, we explore an application of methodology from Han et al. (2022) to identify next best studies based on a meta analysis of relationship between Customer Satisfaction and Retention using the R package `BestNextStudy` 
