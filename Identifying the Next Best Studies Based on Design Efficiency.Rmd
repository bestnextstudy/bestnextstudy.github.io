---
title: 'Identifying the Next Best Studies Based on Design Efficiency'
...
The `BestNextStudy` approach allows you indentify a set of next best studies which when done sequentially will improve the efficiency of the literature on a specific relationship. You can upload your data and the number of next studies you want to calculate in the web application below and get the design characteristics of the studies and corresponding A- and D-efficiency by sequentially adding these studies.
