...
You need to identify the names of the `year` and `correlation` variables in your data in the web application.
  
<iframe src="https://bestnextstudy.shinyapps.io/BestNextStudy_Shiny_Eff_Cal/" class="l-screen-inset shaded" height="1000px"></iframe>
