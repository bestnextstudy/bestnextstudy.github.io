...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-btxf">This application takes the meta-analysis data studying the association between two focal constructs and returns the design characteristics of a set of next best studies which when done sequentially will improve the efficiency of the literature.</td>
  </tr>
  <tr>
