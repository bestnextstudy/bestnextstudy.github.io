...
The `BestNextStudy` approach we propose helps to 
  ...
  3. what should be the optimal next study to further our understanding of the focal association being studied in a meta-analysis
...
<tbody>
  ...
  <tr>
    <td class="tg-btxf">[Identifying the Next Best Studies Based on Design Efficiency](Identifying-the-Next-Best-Studies-Based-on-Design-Efficiency.html)</td>
    <td class="tg-btxf">This application takes the meta-analysis data studying the association between two focal constructs and returns the design characteristics of the best-next studies that would improve the efficiency of the cumulative literature&nbsp;&nbsp;</td>
  </tr>
  <tr>
...
If you want to run these analyses on your own instead of using the web application, we developed a **R package** titled `BestNextStudy` which is available on [GitHub](https://github.com/bestnextstudy/bestnextstudy){target="_blank"}  and can be installed to your local computer by running the following lines of code.

The [application](Application_CS_Retention.html){target="_blank"} page demonstrates the use of BestNextStudy package to understand the association between Customer Satisfaction and Retention using sample data included in the package.
...
```{r load_packages , warning=FALSE , message = FALSE, class.source='klippy'}
